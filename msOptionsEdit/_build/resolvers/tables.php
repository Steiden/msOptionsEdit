...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('msoptionsedit', MODX_CORE_PATH . 'components/msoptionsedit/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/msoptionsedit/model/schema/msoptionsedit.mysql.schema.xml';

msOptionsEdit.grid.ComboboxOptions = function (config) {
    config = config || {};
    if (!config.id) {
    ...
    msOptionsEdit.grid.ComboboxOptions.superclass.constructor.call(this, config);
};

Ext.extend(msOptionsEdit.grid.ComboboxOptions, MODx.grid.LocalGrid, {
...
Ext.reg('minishop2-grid-combobox-options', msOptionsEdit.grid.ComboboxOptions);

msOptionsEdit.grid.ComboboxColors = function (config) {
    config = config || {};
    if (!config.id) {
    ...
    msOptionsEdit.grid.ComboboxColors.superclass.constructor.call(this, config);
};
var nameCell = '';
var existcolors = [];

Ext.extend(msOptionsEdit.grid.ComboboxColors, MODx.grid.LocalGrid, {
...
Ext.reg('minishop2-grid-combobox-colors', msOptionsEdit.grid.ComboboxColors);

...
Ext.extend(msOptionsEdit.window.CreateOption, msOptionsEdit.window.Default, {
...
Ext.reg('minishop2-window-option-create', msOptionsEdit.window.CreateOption);
...
Ext.extend(msOptionsEdit.window.UpdateOption, msOptionsEdit.window.CreateOption);
Ext.reg('minishop2-window-option-update', msOptionsEdit.window.UpdateOption);


msOptionsEdit.window.AssignOptions = function (config) {
    config = config || {};
    ...
    msOptionsEdit.window.AssignOptions.superclass.constructor.call(this, config);
};
Ext.extend(msOptionsEdit.window.AssignOptions, msOptionsEdit.window.Default, {

    getFields: function (config) {
        return [
            {xtype: 'hidden', name: 'options', id: config.id + '-option'},
            {xtype: 'hidden', name: 'categories', id: config.id + '-categories'},
            {
                xtype: 'minishop2-tree-option-categories',
...
Ext.reg('minishop2-window-option-assign', msOptionsEdit.window.AssignOptions);

msOptionsEdit.grid.Option = function (config) {
    config = config || {};
    if (!config.id) {
    ...
    msOptionsEdit.grid.Option.superclass.constructor.call(this, config);
...
Ext.extend(msOptionsEdit.grid.Option, msOptionsEdit.grid.Default, {
...
Ext.reg('minishop2-grid-option', msOptionsEdit.grid.Option);

...
class Minishop2MgrSettingsManagerController extends msManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->miniShop2->config['jsUrl'] . 'mgr/settings/option/values/grid.js');
        $this->addJavascript($this->miniShop2->config['jsUrl'] . 'mgr/settings/option/values/window.js');
        $this->addJavascript($this->miniShop2->config['jsUrl'] . 'mgr/settings/option/merge/grid.js');
        $this->addJavascript($this->miniShop2->config['jsUrl'] . 'mgr/settings/option/merge/option_merge.window.js');
        $this->addJavascript($this->miniShop2->config['jsUrl'] . 'mgr/settings/option/merge/combo_options.js');
